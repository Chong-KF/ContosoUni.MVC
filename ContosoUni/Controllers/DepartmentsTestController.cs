...
namespace ContosoUni.Controllers
{
    ...
    public class DepartmentsTestController : Controller
    {
        ...
        private readonly ILogger<DepartmentsTestController> _logger;
        //private readonly IAzureQueue _azureQueue;

        public DepartmentsTestController(
            ApplicationDbContext context,
            //UserManager<MyIdentityUser> userManager,
            ILogger<DepartmentsTestController> logger
        ...
        {
            //var applicationDbContext = _context.Departments.Where(d => d.IsDeleted == false);
            ...
            {
                IList<Department> departments = await _context.Departments.Where(d => d.IsDeleted == false).ToListAsync();
                ...
                foreach (Department d in departments)
                {
                    ...
                    departmentViewModels.Add(vm);
                }
                //cannot use for unit test
                ...
                return View(nameof(Index), departmentViewModels);
            }
        }
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            return View(nameof(Details), departmentViewModel);
        }
        ...
        public IActionResult Create()
        {
            ...
            DepartmentViewModel departmentViewModel = new();
            return View(nameof(Create), departmentViewModel);
        }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            ViewData["CreatedByUserId"] = new SelectList(_context.Users, "Id", "DisplayName", department.CreatedByUserId);
            ViewData["UpdatedByUserId"] = new SelectList(_context.Users, "Id", "DisplayName", department.UpdatedByUserId);
            return View(nameof(Edit), departmentViewModel);
        }
